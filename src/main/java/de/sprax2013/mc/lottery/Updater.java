...
public class Updater implements Listener {
    public static final String VERSION_TXT_URL = "https://spraxdev.github.io/McLottery/version.txt";

    public static final String SPIGOT_MC_URL = "https://r.spiget.org/84809";    // TODO
    public static final String SONGODA_URL = "https://songoda.com/marketplace/product/489"; // TODO
    public static final String GITHUB_URL = "https://github.com/SpraxDev/McLottery/releases";

    public static final String CHANGELOG_URL = "https://github.com/SpraxDev/McLottery/blob/master/CHANGELOG.md";
    ...
    private void onJoin(PlayerJoinEvent e) {
        ...
        e.getPlayer().spigot().sendMessage(
                new ComponentBuilder("[").color(ChatColor.GRAY)
                        ...
                        .event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(TextComponent.fromLegacyText("§2Click to visit the download page on SpigotMC"))))
                        .append("[Songoda] ")
                        .color(ChatColor.GREEN)
                        .event(new ClickEvent(ClickEvent.Action.OPEN_URL, SONGODA_URL))
                        .event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(TextComponent.fromLegacyText("§2Click to visit the download page on Songoda"))))
                        .append("[GitHub] ")
                        .color(ChatColor.GREEN)
                        .event(new ClickEvent(ClickEvent.Action.OPEN_URL, GITHUB_URL))
                        .event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(TextComponent.fromLegacyText("§2Click to visit the download page on GitHub"))))
                        .append("[Changelog]")
                        .color(ChatColor.DARK_GREEN)
                        .event(new ClickEvent(ClickEvent.Action.OPEN_URL, getChangelogUrl(newerVersion)))
                        .event(new HoverEvent(HoverEvent.Action.SHOW_TEXT, new Text(TextComponent.fromLegacyText("§aClick to see the Changelogs at GitHub.com"))))
                        .create());
    }
